...
class DragonflyItemRepository(CacheSerializerMixin, ItemRepository):
    def __init__(self, url: str):
        self._client = redis.from_url(url, decode_responses=True, protocol=3, max_connections=50)
        self._prefix = "item:df:"
