...
class ValkeyItemRepository(CacheSerializerMixin, ItemRepository):
    def __init__(self, url: str, db: int = 0):
        self._client = redis.from_url(url, db=db, decode_responses=True, protocol=3, socket_timeout=1.5)
        self._prefix = "item:valkey:"
